...
namespace glhm.MyAirport.EF.Migrations
{
    ...
    [Migration("20200228164310_changementsNomsDesColonnes")]
    partial class changementsNomsDesColonnes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("glhm.MyAirport.EF.Bagage", b =>
                {
            ...
            modelBuilder.Entity("glhm.MyAirport.EF.Vol", b =>
                {
                    b.Property<int>("VolId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("glhm.MyAirport.EF.Bagage", b =>
                {
                    b.HasOne("glhm.MyAirport.EF.Vol", "Vol")
                        .WithMany("Bagages")
                        .HasForeignKey("VolId");
                });
